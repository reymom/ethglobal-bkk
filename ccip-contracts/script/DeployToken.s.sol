...
contract DeployToken is Script {
    function run() external {
        ...
        // Grant mint and burn roles to the minter contract only on Scroll
        if (block.chainid == 534351) {
            address tokeMinterContract = 0xD8c4dBFd5bC6bDc0Ac709d556047A413e169950a;
            BurnMintERC677(tokenAddress).grantMintAndBurnRoles(tokeMinterContract);
            console.log("Granted mint and burn roles to:", tokeMinterContract);
        }
