...
contract HelperConfig is Script {
    ...
    function getScrollSepoliaConfig() public pure returns (NetworkConfig memory) {
        NetworkConfig memory scrollSepoliaConfig = NetworkConfig({
            chainSelector: 2279865765895943307,
            router: 0x6aF501292f2A33C81B9156203C9A66Ba0d8E3D21,
            rmnProxy: 0x8f4413e02265F65eF89FB908dbA2915fF9f7F8cB,
            tokenAdminRegistry: 0xf49C561cf56149517c67793a3035D1877ffE2f04,
            registryModuleOwnerCustom: 0x3325786a3eE3Aa488403A136CF9Ad3E764656C75,
            link: 0x231d45b53C905c3d6201318156BDC725c9c3B9B1,
            confirmations: 2,
            nativeCurrencySymbol: "ETH"
        });
        return scrollSepoliaConfig;
    }
}
